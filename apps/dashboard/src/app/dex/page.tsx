...
import { ChainSelector, TokenSelector, SlippageControl, RouteTable, AmountInput } from '../(dex)/components';
...
import { getQuotes } from '../(dex)/lib/api';

export default function DexRoutePage() {
